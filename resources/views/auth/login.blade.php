...
<head>
  ...
  <title>Login Admin - {{ $settings->name }}</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="/auth/login" class="row g-3 needs-validation" method="POST">
                    @csrf
                    @if(session()->has('loginError'))
                      <span class="text-danger text-center">{{ session('loginError') }}</span>
                    @endif
                    <div class="col-12">
